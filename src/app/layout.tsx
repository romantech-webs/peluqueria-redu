  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="peluqueria-redu";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Peluquería Redu"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="peluqueria-redu"
          data-primary-color="#cc8865"
          defer
        ></script>
      </head>
